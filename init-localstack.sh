...
# user
aws --endpoint-url=http://localhost:4569 dynamodb put-item --table-name 529821714029-mtbPaths-local-user --item '{"id":{"S":"64511a6f-fc7c-41fc-bd81-ab3019137404"}, "lastname":{"S":"Gasser"}, "firstname":{"S":"Andreas"},"email":{"S":"andreas.gasser@novartis.com"}, "password":{"S":"$2a$10$O.c3Em.2bXH.UuDugmz/yuGXZIlofsuGu2uO1Poas2vodehTW8FQ2"}}'
