...
# user
aws --endpoint-url=http://localhost:4569 dynamodb put-item --table-name 529821714029-rekognition-backend-local-user --item '{"id":{"S":"64511a6f-fc7c-41fc-bd81-ab3019137404"}, "lastname":{"S":"Gasser"}, "firstname":{"S":"Andreas"},"email":{"S":"andreas.gasser@test.com"}, "password":{"S":"$2a$10$WqlYzHH6KMIzXZW5LjbqjOPmJQUazm.0obVxwVlyWovUlqZM0bn.G"}}'
